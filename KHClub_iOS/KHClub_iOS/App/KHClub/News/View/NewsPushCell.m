...
- (void)setContentWithModel:(NewsPushModel *)model
{
    ...
    [self.headImageView sd_setImageWithURL:[NSURL URLWithString:[ToolsManager completeUrlStr:model.head_image]] placeholderImage:[UIImage imageNamed:DEFAULT_AVATAR]];
    //名字
    ...
    if (model.news_image.length > 0) {
        ...
        [self.newsImageView sd_setImageWithURL:[NSURL URLWithString:[ToolsManager completeUrlStr:model.news_image]] placeholderImage:[UIImage imageNamed:@"loading_default"]];
