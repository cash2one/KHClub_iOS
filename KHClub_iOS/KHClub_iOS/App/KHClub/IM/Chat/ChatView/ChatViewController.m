...
{
    if (_tableView == nil) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, kNavBarAndStatusHeight, self.view.frame.size.width, self.view.frame.size.height - self.chatToolBar.frame.size.height - kNavBarAndStatusHeight) style:UITableViewStylePlain];
...
//                        UserProfileEntity *user = [[UserProfileManager sharedInstance] getUserProfileByUsername:model.username];
                        UserIMEntity * user = [[IMUtils shareInstance] getUserInfoWithUsername:model.username];
...
- (void)didChangeFrameToHeight:(CGFloat)toHeight
{
    [UIView animateWithDuration:0.3 animations:^{
        ...
        rect.origin.y = kNavBarAndStatusHeight;
        rect.size.height = self.view.frame.size.height - toHeight - kNavBarAndStatusHeight;
