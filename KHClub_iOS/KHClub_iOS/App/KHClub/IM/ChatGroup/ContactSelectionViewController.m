...
//    [self.view addSubview:self.footerView];
    [self setNavBarTitle:NSLocalizedString(@"title.chooseContact", @"select the contact")];
    
    self.tableView.editing = YES;
    self.tableView.frame = CGRectMake(0, kNavBarAndStatusHeight, self.viewWidth, self.viewHeight - kNavBarAndStatusHeight);
