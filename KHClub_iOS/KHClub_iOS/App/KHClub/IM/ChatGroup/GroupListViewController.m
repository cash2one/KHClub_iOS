...
//    [[EaseMob sharedInstance].chatManager addDelegate:self delegateQueue:nil];
    ...
    [self setNavBarTitle:NSLocalizedString(@"title.group", @"Group")];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[IMUtils shareInstance] setGroupImageWith:group.groupId and:cell.imageView];
    [[IMUtils shareInstance] setGroupNameWith:group.groupId and:cell.textLabel andGroupTitle:group.groupSubject];
